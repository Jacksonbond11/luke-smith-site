...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-6 bg-gradient-to-b from-black/80 to-transparent">
      <nav className="flex justify-center">
        <ul className="flex space-x-8 text-2xl font-bold tracking-widest">
